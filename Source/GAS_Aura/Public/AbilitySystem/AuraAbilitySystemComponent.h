...
DECLARE_MULTICAST_DELEGATE_TwoParams(FAbilityStatusChanged, const FGameplayTag& /* AbilityTag */, const FGameplayTag& /* Status Tag*/);
...
public:
	...
	FGameplayAbilitySpec* GetSepcFromAbilityTag(const FGameplayTag& AbilityTag);
